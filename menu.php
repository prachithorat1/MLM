            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="profile.php"><i class="fa fa-adjust fa-fw"></i> Profile</a>
                        </li>
                        <li>
                            <a href="bank-details.php"><i class="fa fa-adjust fa-fw"></i>Bank Details</a>
                        </li>
                        <li>
                            <a href="deposit.php"><i class="fa fa-adjust fa-fw"></i>Deposit</a>
                        </li>
                        <li>
